    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
          ...
          <CardContent className="space-y-4">
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="john.doe@university.edu" className="h-11" />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input id="institution" placeholder="University of Excellence" className="h-11" />
              </div>
              ...
              <Button className="w-full h-11 bg-emerald-600 hover:bg-emerald-700">Create Account</Button>
            </form>
        ...
        <div className="mt-8 space-y-4">
          <h3 className="text-center text-sm font-medium text-gray-700">What you'll get:</h3>
